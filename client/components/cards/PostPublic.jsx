                        ...
                        <div className={styles.reactionDiv}>
                            <div className={styles.reactionandcomments}>
                                {state && state.user && post.likes && post.likes.includes(state.user._id) ?
                                    (<FavoriteIcon onClick={() => handleUnlike(post._id)} className={styles.reactionIcons} />)
                                    : (<FavoriteBorderIcon onClick={() => handleLike(post._id)} className={styles.reactionIcons} />)
                                }
                                ...
                                <div style={{ margin: "0 5px" }}>
                                    <Link href={`/post/view/${post._id}`} passHref>
